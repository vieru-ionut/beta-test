...
def get_ds60364_data(insulation, loaded_cond, material="Cu"):
    ...
    if material == "Al":
        if insulation == "PVC":
            if loaded_cond == 2:
                return {
                    "Cable Tray (E)":        [0, 0, 0, 0, 0, 73.3, 92.8, 115.4, 140.4, 181.0, 220.0, 255.8, 295.6, 338.5, 400.9, 462.5],
                    "In Conduit (B2)":       [0, 0, 0, 0, 0, 53.8, 70.2,  86.6, 103.7, 131.0, 156.8, 181.0, 201.2, 229.3, 268.3, 307.3],
                ...
                return {
                    "Cable Tray (E)":        [0, 0, 0, 0, 0, 62.4, 78.8,  98.3, 119.3, 152.9, 185.6, 215.3, 248.8, 283.9, 335.4, 387.7],
                    "In Conduit (B2)":       [0, 0, 0, 0, 0, 48.4, 62.4,  77.2,  92.0, 116.2, 139.6, 160.7, 175.5, 198.9, 231.7, 264.4],
            ...
            if loaded_cond == 2:
                return {
                    "Cable Tray (E)":        [0, 0, 0, 0, 0,  89.7, 116.2, 144.3, 175.5, 225.4, 274.6, 319.8, 368.9, 422.8, 500.0, 578.0],
                    "In Conduit (B2)":       [0, 0, 0, 0, 0,  71.0,  92.8, 113.9, 136.5, 172.4, 206.7, 237.9, 260.5, 299.5, 358.0, 415.0],
                ...
                return {
                    "Cable Tray (E)":        [0, 0, 0, 0, 0,  78.0,  99.1, 123.2, 149.8, 191.9, 232.4, 269.9, 311.2, 355.7, 419.6, 484.4],
                    "In Conduit (B2)":       [0, 0, 0, 0, 0,  62.4,  81.9,  99.8, 120.1, 151.3, 181.7, 209.0, 234.0, 265.2, 310.4, 354.9],
